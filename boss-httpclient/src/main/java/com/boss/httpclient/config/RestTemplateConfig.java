package com.boss.httpclient.config;

import com.boss.httpclient.properties.HttpPoolProperties;
...
public class RestTemplateConfig {
    ...
    public HttpClient httpClient() {
        Registry<ConnectionSocketFactory> registry = RegistryBuilder.<ConnectionSocketFactory>create()
                .register("com/boss/httpclient", PlainConnectionSocketFactory.getSocketFactory())
