...
import com.boss.cache.job.QuartzNewsJob;
...
public class JobAndTriggerImpl implements JobAndTriggerService {
    ...
    public void addJob(TaskInfo taskInfo) {
        try {
            ...
            log.info("===========>创建定时任务成功JobName:" + taskInfo.getJobName() + ",JobGroup:" + taskInfo.getJobGroup());
        } catch (Exception e) {
    ...
    private Class<? extends Job> getJobClass(String dataType) {
        ...
        switch (dataType.toUpperCase()) {
            ...
            case "NEWS":
                ...
                break;
            case "DIANPING":
                //jobClass = QuartzDianPingJob.class;
                break;
            case "DZHSTOCK":
                //jobClass = QuartzDzhStockJob.class;
                break;
            case "DIRECTORY":
                //jobClass = DirectoryCleanJob.class;
                break;
            default:
                jobClass = null;
                break;
