...
@Order(0)
@WebFilter(filterName = "contextPathVariableFilter", urlPatterns = "/*")
public class ContextPathVariableFilter implements Filter {
    ...
    public void destroy() {
         ...
         */
        System.out.println("ContextPathVariableFilter过滤路径销毁");
    }
    ...
    public void init(FilterConfig arg0) throws ServletException {
         ...
         */
        System.out.println("ContextPathVariableFilter过滤路径初始化");
    }
